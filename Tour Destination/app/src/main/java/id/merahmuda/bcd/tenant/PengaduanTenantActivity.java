...
public class PengaduanTenantActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pengaduan_tenant);
        setTitle("Pengaduan");
        ...
        call.enqueue(new Callback<ResponsePengaduan>() {
            ...
            public void onResponse(Call<ResponsePengaduan> call, Response<ResponsePengaduan> response) {
                if (response.isSuccessful()){
                    ...
                    Toast.makeText(PengaduanTenantActivity.this, "Gagal mengambil data.", Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<ResponsePengaduan> call, Throwable t) {
                Toasty.error(PengaduanTenantActivity.this, "Koneksi Internet Bermasalah", Toast.LENGTH_SHORT, true).show();
            }
        });
    }
